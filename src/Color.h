...
private:
  ...
  unsigned int toOleColor(unsigned char alpha, unsigned char red, unsigned char green, unsigned char blue);
  void fromOleColor(unsigned int oleColor, unsigned int *r, unsigned int *g, unsigned int *b);
};
